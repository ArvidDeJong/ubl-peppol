...
| VAT categories: an exemption reason for `E` (BR-E-10), a delivery date and country for `K` (BR-IC-11, BR-IC-12), `O` alone (BR-O-11). See [VAT categories](vat-categories.md#what-validate-checks) | Yes | Yes |
