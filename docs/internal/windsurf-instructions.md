...
Authoritative PEPPOL BIS rule source (source of truth):

- https://docs.peppol.eu/poacc/billing/3.0/bis/

When reading, validating, implementing, or explaining PEPPOL rules for BE/NL, consult this BIS page first.
...
### Belgian Specifications (after checking BIS source)
...
- Documentation: https://docs.peppol.eu/poacc/billing/3.0/bis/
...
3. Consult https://docs.peppol.eu/poacc/billing/3.0/bis/ before interpreting or applying PEPPOL rules
4. Validate generated XML against official PEPPOL validators
5. Pay attention to country-specific requirements like VAT number formats and tax categories
6. Use the test data structure as a basis for new implementations
