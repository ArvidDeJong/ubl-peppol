...
describe('UblNlBis3Service', function () {
    ...
    it('can be instantiated', function () {
        expect($this->service)->toBeInstanceOf(UblNlBis3Service::class);
    });
...
describe('UblNlBis3Service Helper Methods', function () {
    ...
    it('can add child elements with addChildElement method', function () {
        ...
        expect($childElement->nodeValue)->toBe('TEST-001');
